...
export default function Contacts() {
  ...
  return (
    <div className="grid auto-cols-fr grid-flow-col w-[70%]" id="contacts">
      <div className="flex flex-col items-start items-center gap-y-[20px]">
        <div className="w-full">
          <span className="typeface">Мы находимся по адресу: </span>
          <span
            className="typeface text-accent underline hover:opacity-50 transition-opacity cursor-pointer"
